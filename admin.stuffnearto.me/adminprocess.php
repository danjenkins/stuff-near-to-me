...
class AdminProcess
{
   ...
   function procUpdateLevel(){
      ...
      /* Update user level */
         ...
         header("Location: /users?action=updatedUserLevel&user=$subuser");
      }
   }
   ...
   function procDeleteUser(){
      ...
      /* Delete user from database */
         ...
         $database->query($q);
         header("Location: /users?user=$subuser&action=deletedUser");
      }
   }
   ...
   function procDeleteInactive(){
      ...
      $database->query($q);
      header("Location: /users?action=deletedBannedUsersWithInactivityOf".$_POST['inactdays']."Days");
   }
   ...
   function procBanUser(){
      ...
      /* Ban user from member system */
         ...
         $database->query($q);
         header("Location: /users?user=$subuser&action=bannedUser");
      }
   }
   ...
   function procDeleteBannedUser(){
      ...
      /* Delete user from database */
         ...
         $database->query($q);
         header("Location: /users?user=$subuser&action=deletedBannedUser");
      }
   }
