<h2>Search results - <span class="searchTerm">{if $smarty.request.search}{$smarty.request.search}{elseif $smarty.request.lat && $smarty.request.lon}Location based search{/if}</span></h2>
...
<div class="leftCont">
	{if $searchResults|@count > 0}
		...
		{/foreach}
	{else}
		<p>Sorry, we couldn't match your term, we're working to improve this</p>
	{/if}
</div>
